...
export default function Home() {
  ...
  const faqs = [
    {
      q: "What is Starflow?",
      a: "Starflow is a CRM built for OnlyFans chatting agencies. It lets you manage multiple Telegram accounts, run chatters across dozens of conversations, and send locked paid media — all from one dashboard.",
    },
    {
      q: "Who is it for?",
      a: "Chatting agencies managing OnlyFans models on Telegram. If you have a team of chatters handling DMs across multiple creator accounts, Starflow was built specifically for you.",
    },
    {
      q: "How does the paid media work?",
      a: "Chatters can send locked media directly from the inbox. Fans pay with Telegram Stars. You upload content once to the Vault and reuse it across any conversation — no re-uploading every time.",
    },
    {
      q: "Do I need a Telegram bot?",
      a: "Yes — each account connects its own bot token. Setup takes under 2 minutes via BotFather. The bot handles locked media delivery while your chatters run conversations normally.",
    },
    {
      q: "How many accounts can I add?",
      a: "As many as you need. There's no per-account cap on your plan — add all your creators, assign chatters, and manage everything from one place.",
    },
    {
      q: "Is my team's access controlled?",
      a: "Yes. Chatters only see conversations they're assigned to. Agency admins have full visibility. Role-based access is built in from day one.",
    },
  ];
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Chatters see only their assigned accounts. Admins see everything. Security built in, not bolted on.",
    },
  ];
      ...
      <section className="pt-32 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Manage multiple creator accounts, run your chatter team, and sell locked media via Telegram Stars — all from one dashboard.
          </p>
          ...
          <div className="rounded-2xl border border-white/10 bg-[#111118] overflow-hidden shadow-2xl shadow-black/60">
            ...
            <div className="flex h-72">
              ...
              <div className="w-56 border-r border-white/5 bg-[#0d0d14] p-3 flex flex-col gap-1">
                ...
                {["@rosalie_red", "@kat_pixzy", "@forgotten.belle", "@kimberly.c"].map((name, i) => (
      ...
      <section className="py-12 border-y border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 text-gray-500">
            {["Telegram", "OnlyFans", "Fansly", "Fanvue", "MyM", "JustForFans"].map((p) => (
            ...
            <div className="bg-[#111118] border border-white/8 rounded-2xl p-7">
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  "Chatters lose context switching accounts",
      ...
      <section id="pricing" className="py-24 px-6 bg-[#0d0d14]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mb-4">Simple, flat pricing</h2>
            <p className="text-gray-400 max-w-xl mx-auto">One plan. Unlimited accounts. No per-seat fees, no per-message costs. Just a flat monthly rate.</p>
          </div>
          <div className="max-w-sm mx-auto">
            <div className="bg-[#111118] border border-blue-500/30 rounded-2xl p-8 relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-500/50 to-transparent" />
              <div className="absolute top-3 right-4 text-xs bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded-full border border-blue-500/20">
                Early access
              </div>
              ...
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="font-semibold text-white text-lg">Starflow Agency</span>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-1">Unlimited accounts. Unlimited chatters.</p>
              </div>

              <div className="flex flex-col gap-3 mb-8">
                {[
                  "Unlimited Telegram accounts",
                  "Unlimited chatter seats",
                  "Full inbox & conversation management",
                  "Vault — upload once, send anywhere",
                  "Locked media via Telegram Stars",
                  "Role-based access control",
                  "Real-time revenue dashboard",
                  "0% fees on manual paid media",
                ].map((item) => (
                  <div key={item} className="flex items-start gap-2.5 text-sm text-gray-300">
              ...
              <Link href="/signup" className="block w-full text-center bg-blue-600 hover:bg-blue-500 text-white py-3.5 rounded-xl font-semibold transition-all hover:scale-[1.02] shadow-lg shadow-blue-500/20">
                Get started free
              </Link>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-start justify-between gap-8">
            <div className="max-w-xs">
              ...
              <p className="text-sm text-gray-500">The CRM for OnlyFans chatting agencies managing Telegram accounts at scale.</p>
            </div>
