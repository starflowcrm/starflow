    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="border-b border-white/[0.06] bg-[#0e0e0e] px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/inbox" className="text-white/50 hover:text-white text-sm">← Inbox</Link>
        ...
        <Card className="bg-[#111] border-white/[0.06]">
          <CardContent className="pt-5">
            ...
            <p className="text-xs text-white/40 mb-4">
              Files are uploaded via Telethon (up to 2GB). Once uploaded, send to any chat instantly — no re-uploading needed.
            </p>
            <form onSubmit={handleUpload} className="grid grid-cols-1 sm:grid-cols-4 gap-3 items-end">
              ...
              <div className="space-y-1">
                <Label className="text-xs text-white/50">Default ⭐ price</Label>
                ...
                <div key={item.id} className="bg-[#111] border border-white/[0.06] rounded-xl overflow-hidden group">
                  ...
                  <div className="p-3 space-y-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-yellow-400">{item.default_star_price} ⭐</span>
                    </div>
